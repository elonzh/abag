...
sudo apt install -y zsh autojump git apt-transport-https ca-certificates curl gnupg2 software-properties-common docker-ce docker-compose mycli fonts-powerline
